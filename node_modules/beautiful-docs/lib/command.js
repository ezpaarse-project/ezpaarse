...
(function() {
  var arg, argv, bfdocs, destDir, fs, generateIndex, generateManifest, handleManifest, loadManifests, lock, manifests, options, parts, path, startServer, switches, v, _, _i, _len, _ref;
  ...
  generateManifest = function(manifest, callback) {
    ...
    if (argv.length > 1) {
      ...
      _.extend(opts, {
        baseUrl: options.baseUrl + '/' + manifest.slug
      });
    }
