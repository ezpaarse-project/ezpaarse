 ...
 * }
 */
function FieldSplitter(ufSplitters) {
  this.ufSplitters = ufSplitters;
}
module.exports = FieldSplitter;

FieldSplitter.prototype.split = function (ec) {
  for (var i in this.ufSplitters) {
    var splitter = this.ufSplitters[i];
