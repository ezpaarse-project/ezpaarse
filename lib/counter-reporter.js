 ...
 */
CounterReporter.prototype.getIdentifiers = function (ec) {
  var ecIdentifiers = {};
 ...
 */
CounterReporter.prototype.getJournal = function (ecIdentifiers) {
  var journal;
 ...
 */
CounterReporter.prototype.updateJournal = function (journal, ecIdentifiers) {
  for (var identifier in ecIdentifiers) {
 ...
 */
CounterReporter.prototype.generateReport = function () {
  var self = this;
