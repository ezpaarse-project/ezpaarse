...
ReportManager.prototype.updateFile = function (callback) {
  fs.writeFile(this.file, JSON.stringify(this.report, null, 2), callback);
};
...
ReportManager.prototype.finalize = function (callback, socket) {
  ...
  self.updateFile(function () {
    self.updateGeneralUsage(callback);
...
ReportManager.prototype.updateComputed = function () {
  var nbRejects     = this.get('rejets', 'nb-lines-unknown-format');
