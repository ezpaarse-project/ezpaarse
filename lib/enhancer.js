    ...
    pkbManager.get(ec.platform, function (pkb) {
      if (pkb) {
        ...
        if (info) {
          ...
          self.job.logger.silly('The PID couldn\'t be found in the PKB [log line n°' + ec._meta.lineNumber + ']');
        ...
        self.job.logger.silly('No knowledge base found [log line n°' + ec._meta.lineNumber + ']');
      }
