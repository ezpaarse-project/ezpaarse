...
/**
 * Browse the PKBs files of a platforms and remove old duplicates
...
module.exports = function (platform, options) {
  ...
  var pkbDir = path.join(__dirname, '../platforms', platform, 'pkb');
  ...
  fs.readdir(pkbDir, function (err, files) {
    ...
    var rewriteFiles = function () {
      ...
      var filePath = path.join(pkbDir, file);
