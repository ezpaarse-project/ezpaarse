...
var LineProcessor = function (req) {
  ...
  (function defineProcess() {
    ...
    ecOrganizer2.on('drain', function () {
      var jr1 = counterReporter.generateReport();
      fs.writeFileSync(path.join(job.jobPath, 'jr1.xml'), jr1);
      self.emit('end');
    });
  })();
