...
describe('ezPAARSE processes a log file with an unsupported output format requested', function () {
...
describe('ezPAARSE processes a basic log file with an empty field in the Output-Fields header', function () {
...
describe('ezPAARSE processes a basic log file with an operator-less field in Output-Fields header', function () {
...
describe('ezPAARSE processes a basic log file with a user-field header group missing SRC', function () {
...
describe('ezPAARSE processes a basic log file with a user-field header group missing SEP', function () {
...
describe('ezPAARSE processes a basic log file with a user-field header group missing DEST', function () {
...
describe('ezPAARSE processes a basic log file with a user-field header group containing fieldname doublons', function () {
...
function processLogAndTestLsof(log, headers, done) {
  ...
  lsof.raw(ezpaarsePid, function(data) {
    lsofBefore = data;
    helpers.post('/', log, headers, function (err, res, body) {
      ...
      lsof.raw(ezpaarsePid, function(data) {
        ...
        (lsofAfter.length).should.be.equal(lsofBefore.length);
