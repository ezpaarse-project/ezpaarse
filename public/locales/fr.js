...
ezLanguages['fr'] = {
  // Demo warning
  "demo+warning_header": "Cette instance d'ezPAARSE est utilisable à titre de démonstration.",
  "demo+warning_text": "Nous déconseillons vivement son usage en production ou pour des logs volumineux.",
  ...
  // PKBs state
  "castor+synchronizing": "Synchronisation des PKBs... [{{ remaining }} fichiers restants]",
  ...
  "settings+default_parser":       "Parseur par défaut",
  "settings+default_parser_help":  "Parseur à utiliser pour les URLs sans nom de domaine ou sans parseur associé.",
  ...
  "settings+crypted_fields":       "Champs cryptés",
  "settings+crypted_fields_add":   "Ajouter...",
  "settings+crypted_fields_help":  "Les champs renseignés ici seront cryptés. Les valeurs cryptées ne sont pas comparables entre plusieurs traitements.",
  ...
  "settings+metadata-enrichment":  "Enrichissement des métadonnées",
  ...
  "admin+middlewares_are_uptodate":   "Les middlewares sont à jour",
  ...
  "admin+middlewares":                "Middlewares",
  "admin+middlewares_description":    "Éléments de la chaîne de traitement d'ezPAARSE.",
  ...
  "admin+soft_local_changes":         "Des modifications locales semblent avoir été apportées au code source du logiciel. Il est possible que les prochaines mises à jour échouent.",
  "admin+soft_upward_stable":         "La version actuelle du logiciel présente des changements ultérieurs à la dernière version stable. Cliquez sur le bouton ci-dessus si vous souhaitez revenir à la dernière version stable.",
  "admin+platforms_local_changes":    "Des modifications locales semblent avoir été apportées au répertoire des plateformes. Il est possible que les prochaines mises à jour échouent.",
  "admin+resources_local_changes":    "Des modifications locales semblent avoir été apportées au répertoire des ressources. Il est possible que les prochaines mises à jour échouent.",
  "admin+middlewares_local_changes":  "Des modifications locales semblent avoir été apportées au répertoire des middlewares. Il est possible que les prochaines mises à jour échouent.",
