...
ezLanguages['en'] = {
  ...
  "form+curl_instructions": "Copy the following command to run the query with cURL using the current setting of the form. You may need to change the instance URL, the file path or add options like <code>--proxy</code> or <code>--no-buffer</code>.",
  ...
  "settings+default_parser":       "Default parser",
  "settings+default_parser_help":  "Parser to use for URLs that don't have a domain name or a matching parser.",
  ...
  "settings+crypted_fields":       "Crypted fields",
  "settings+crypted_fields_add":   "Add...",
  "settings+crypted_fields_help":  "These fields will be crypted. Crypted values are not comparable between different processes.",
  ...
  "admin+middlewares_are_uptodate":   "Middlewares are up-to-date",
  ...
  "admin+middlewares_description":    "Components of the process chain of ezPAARSE.",
  "admin+resources_description":      "Predefined settings and other resources that don't depend on ezPAARSE version.",
  "admin+resources_refresh_notice":   "Right after an update, remember to refresh the page (F5) so that all changes take effect.",
