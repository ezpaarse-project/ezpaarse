...
${LangFileString} menu+2_utiliser "2-Utiliser le formulaire ezPAARSE.lnk"
${LangFileString} menu+3_tester "3-Tester avec des echantillons de log.lnk"
${LangFileString} menu+4a_visualiser "4-Visualiser les resultats avec Excel.lnk"
${LangFileString} menu+4b_visualiser "4-Visualiser les resultats avec LibreOffice.lnk"
${LangFileString} menu+4c_arreter "5-Arreter le serveur ezPAARSE.lnk"
