...
build-docker: ## Build ezpaarseproject/ezpaarse:3.2.8 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.2.8 --build-arg http_proxy --build-arg https_proxy .
