...
build-docker: ## Build ezpaarseproject/ezpaarse:3.2.5 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.2.5 --build-arg http_proxy --build-arg https_proxy .
