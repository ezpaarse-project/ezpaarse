...
build-docker: ## Build ezpaarseproject/ezpaarse:3.7.4 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.7.4 --build-arg http_proxy --build-arg https_proxy .
