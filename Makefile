...
build-docker: ## Build ezpaarseproject/ezpaarse:2.12.3 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:2.12.3 --build-arg http_proxy --build-arg https_proxy .
