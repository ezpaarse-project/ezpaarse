...
build-docker: ## Build ezpaarseproject/ezpaarse:3.6.1 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.6.1 --build-arg http_proxy --build-arg https_proxy .
