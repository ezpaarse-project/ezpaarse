...
build-docker: ## Build ezpaarseproject/ezpaarse:3.7.3 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.7.3 --build-arg http_proxy --build-arg https_proxy .
