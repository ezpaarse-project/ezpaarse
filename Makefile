...
build-docker: ## Build ezpaarseproject/ezpaarse:3.10.9 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.10.9 --build-arg http_proxy --build-arg https_proxy .
