...
build-docker: ## Build ezpaarseproject/ezpaarse:3.4.2 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.4.2 --build-arg http_proxy --build-arg https_proxy .
