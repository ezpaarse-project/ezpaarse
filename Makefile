...
build-docker: ## Build ezpaarseproject/ezpaarse:2.12.2 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:2.12.2 --build-arg http_proxy --build-arg https_proxy .
