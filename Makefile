...
build-docker: ## Build ezpaarseproject/ezpaarse:3.5.0 docker image locally
	@docker build -t ezpaarseproject/ezpaarse:3.5.0 --build-arg http_proxy --build-arg https_proxy .
